...
const Blog = () => {
    return (
        <div className='bg-red-100'>
           <div className='mb-5 bg-violet-400 p-10 text-center lg:w-9/12 mx-auto'>
           ...
           <div className='mb-5 bg-violet-200 p-10 text-center lg:w-9/12 mx-auto'>
           ...
           <div className='mb-5 bg-violet-300 p-10 text-center lg:w-9/12 mx-auto'>
